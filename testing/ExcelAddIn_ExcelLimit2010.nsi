...
!macro mcrRemoveSymlixAddInRegistry ExcelPath ExcelVersion
  ...
  loopEx:
    ...
    StrCmp $1 "16.0" confirmExcelNoTested ; reverse order to get actual installed version
    StrCmp $1 "15.0" confirmExcelNoTested ; reverse order to get actual installed version
